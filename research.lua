...
t.icons = {{icon="__warptorio-space-age-shaydz-fork__/graphics/destinations/asteroid.png",icon_size=128,}}
t.hidden =false
...
local t = table.deepcopy(data.raw["technology"]["rocket-silo"])
t.icons = {{icon="__warptorio-space-age-shaydz-fork__/graphics/locations/black-hole.png",icon_size=256,}}
t.hidden =false
t.localised_name = nil
