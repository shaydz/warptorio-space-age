...
cargo_chest_entity.picture =
  {
    ...
    {
      {
        filename = "__warptorio-space-age-shaydz-fork__/graphics/entities/cargo-chest.png",
        priority = "extra-high",
        width = 512,
        height = 384,
      ...
      {
        filename = "__warptorio-space-age-shaydz-fork__/graphics/entities/cargo-chest-shadow.png",
        priority = "extra-high",
        width = 512,
        height = 384,
        shift = util.by_pixel(32, 0),
      ...
      {
        filename = "__warptorio-space-age-shaydz-fork__/graphics/entities/cargo-chest-glow.png",
        priority = "extra-high",
        width = 512,
        height = 384,
        shift = util.by_pixel(32, 0),
