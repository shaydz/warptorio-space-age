...
local ei_containers_entity_path = "__warptorio-space-age-shaydz-fork__/graphics/entities/"
local ei_containers_item_path = "__warptorio-space-age-shaydz-fork__/graphics/items/"
